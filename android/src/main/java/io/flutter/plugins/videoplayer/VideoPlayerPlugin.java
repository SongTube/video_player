...
public class VideoPlayerPlugin implements FlutterPlugin, VideoPlayerApi {
  ...
  public TextureMessage create(CreateMessage arg) {
    ...
    if (arg.getVideoAsset() != null) {
      ...
      if (arg.getPackageName() != null) {
        ...
        audioAssetLookupKey = flutterState.keyForAsset.get(arg.getAudioAsset());
      }
      player =
          new VideoPlayer(
              ...
              eventChannel,
              handle,
              "asset:///" + videoAssetLookupKey,
              "asset:///" + audioAssetLookupKey,
              null,
              null,
              options);
    } else {
  ...
  public void setVideoUrl(StringMessage arg) {
    VideoPlayer player = videoPlayers.get(arg.getTextureId());
    player.setVideoUrl(flutterState.applicationContext, arg.getText());
  }
  
  public void setAudioUrl(StringMessage arg) {
    VideoPlayer player = videoPlayers.get(arg.getTextureId());
    player.setAudioUrl(flutterState.applicationContext, arg.getText());
  }
